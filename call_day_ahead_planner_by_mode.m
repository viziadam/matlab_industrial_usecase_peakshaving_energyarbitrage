...
%
% Fast kapcsolo:
%   dispatch_cfg.useFastDayAheadMILP = false -> normal MILP
%   dispatch_cfg.useFastDayAheadMILP = true  -> fast MILP
%
% A peak_only es energy_only logika a sajat wrapper fuggvenyeben marad.
% A combined ag kozvetlenul a contract MILP-et hivja, mert ez maga a
% combined day-ahead planner.
        ...
        case "dc"
            ...
            switch objectiveMode
                ...
                case "combined"
                    ...
                    if useFast
                        plan_full = ems_day_ahead_planner_milp_contract_fast_dc( ...
                            P_load_48h, ...
                            P_pv_48h, ...
                            Prices_48h, ...
                            pars, ...
        ...
        case "ac"
            ...
            switch objectiveMode
                ...
                case "combined"
                    ...
                    if useFast
                        plan_full = ems_day_ahead_planner_milp_contract_fast_ac( ...
                            P_load_48h, ...
                            P_pv_48h, ...
                            Prices_48h, ...
                            pars, ...
