...
%   - lekotott teljesitmeny optimalizalas
    ...
    cfg.converter.central_inv.eta_nom = 0.975;
    ...
    cfg.converter.dcdc.eta_nom = 0.975;
    ...
    cfg.converter.pcsb.eta_nom = 0.97;
    ...
    % =====================================================================
    cfg.candidates.BESS_PV_ratio_vec = 0:0.2:3;
    cfg.candidates.hybrid.BESS_PV_ratio_vec = 0.2:0.2:1.5;
