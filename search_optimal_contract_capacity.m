...
%
% A korabbi aktiv logika helyett ez a verzio nem validacios napokra es nem
% planner-kimenetre szamol koltseget, hanem:
%
%   1) egyszer kivalaszt egy teljes reprezentans honapot,
%   2) minden P_contract jeloltre lefuttatja a teljes honapot,
%   3) minden nap:
%        planner -> realtime decision -> DC/AC topology,
%   4) a havi koltseget a topology utani tenyleges grid importbol szamolja.
%
% A rep_set_proxy es rep_set_valid bemenetek a regi interfesz miatt
% megmaradnak, de az uj keresesi modszerben nem ezek valasztjak ki a
% szimulacios napokat.
    ...
    cost_fun = @(contract_candidate_kW) simulate_contract_month_for_capacity( ...
        day_cache, ...
        month_day_indices, ...
        pars, ...
        tariff, ...
    ...
    best_detail = simulate_contract_month_for_capacity( ...
        day_cache, ...
        month_day_indices, ...
        pars, ...
        tariff, ...
    ...
    % Kompatibilitas a korabbi kiertokelo / plotolo kodokkal.
...
%
% A keresesi feltetelezes:
%   A P_contract koltsegfuggveny praktikusan egyvolgyu jellegu:
%       - alacsony contract -> magas overrun
%       - magas contract -> magas fix teljesitmenydij
%       - kozte optimum.
%
% A vegso intervallumon finom racson tortenik a valasztas.
